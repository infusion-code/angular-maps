...
export class GooglePolygon implements Polygon {
    ...
    public GetPath(): Array<ILatLong> {
        let p: Array<GoogleMapTypes.LatLng> =  this._polygon.getPath();
        let path: Array<ILatLong>  = new Array<ILatLong>();
    ...
    public GetPaths(): Array<Array<ILatLong>> {
        let p : Array<Array<GoogleMapTypes.LatLng>> = this._polygon.getPaths();
        let paths: Array<Array<ILatLong>> = new Array<Array<ILatLong>>();
        p.forEach(x => {
            let path: Array<ILatLong>  = new Array<ILatLong>();
    ...
    public SetPaths(paths: Array<Array<ILatLong>> | Array<ILatLong>): void {
        ...
        if(Array.isArray(paths[0])){
            ...
            let p: Array<Array<GoogleMapTypes.LatLng>> = new Array<Array<GoogleMapTypes.LatLng>>();
            (<Array<Array<ILatLong>>>paths).forEach(path => {
                let _p: Array<GoogleMapTypes.LatLng> = new Array<GoogleMapTypes.LatLng>();
