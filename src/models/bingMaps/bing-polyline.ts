...
export class BingPolyline implements Polyline {
    ...
    public SetDraggable(draggable: boolean): void {
        ...
        /// for a possible approach to be implemented in the model. 
        ///
        throw ("The bing maps implementation currently does not support draggable polylines.");
    }
    ...
    public SetPath(path: Array<ILatLong>): void {
        if (!this._isEditable) throw ("Polyline is not editable. Use Polyline.SetEditable() to make the polygon editable.");
